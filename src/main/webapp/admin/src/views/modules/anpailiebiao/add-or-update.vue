    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="安排名称" prop="anpailiebiaoName">
                       <el-input v-model="ruleForm.anpailiebiaoName"
                                 placeholder="安排名称" clearable  :readonly="ro.anpailiebiaoName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="安排名称" prop="anpailiebiaoName">
                           <el-input v-model="ruleForm.anpailiebiaoName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="安排类型" prop="anpailiebiaoTypes">
                        <el-select v-model="ruleForm.anpailiebiaoTypes" :disabled="ro.anpailiebiaoTypes" placeholder="请选择安排类型">
                            <el-option
                                v-for="(item,index) in anpailiebiaoTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="安排类型" prop="anpailiebiaoValue">
                        <el-input v-model="ruleForm.anpailiebiaoValue"
                            placeholder="安排类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="安排详情" prop="anpailiebiaoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.anpailiebiaoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.anpailiebiaoContent" label="安排详情" prop="anpailiebiaoContent">
                            <span v-html="ruleForm.anpailiebiaoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
               ...
               <!--<el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="分钟" prop="fenzhong">
                       <el-input v-model="ruleForm.fenzhong"
                                 placeholder="分钟" clearable  :readonly="ro.fenzhong"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="分钟" prop="fenzhong">
                           <el-input v-model="ruleForm.fenzhong"
                                     placeholder="分钟" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否完成" prop="wanchengTypes">
                        <el-select v-model="ruleForm.wanchengTypes" :disabled="ro.wanchengTypes" placeholder="请选择是否完成">
                            <el-option
                                v-for="(item,index) in wanchengTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否完成" prop="wanchengValue">
                        <el-input v-model="ruleForm.wanchengValue"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    anpailiebiaoName: false,
                    anpailiebiaoTypes: false,
                    anpailiebiaoContent: false,
                    kaishiTime: false,
                    jieshuTime: false,
                    fenzhong: false,
                    wanchengTypes: false,
                ...
                anpailiebiaoTypesOptions : [],
                wanchengTypesOptions : [],
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=anpailiebiao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.anpailiebiaoTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=wancheng_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.wanchengTypesOptions = data.data.list;
                    }
                });
                this.$http({
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`anpailiebiao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.anpailiebiaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
